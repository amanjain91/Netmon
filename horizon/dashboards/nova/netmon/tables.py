...
'''
class MonitorTable(tables.DataTable):
	machine_a = tables.Column("machine_a", verbose_name=("VMachine A"))
	machine_b = tables.Column("machine_b", verbose_name=("VMachine B"))
	current_load_src = tables.Column("current_load_src", verbose_name=("Packets in"))
	current_load_dst = tables.Column("current_load_dst", verbose_name=("Packets out"))
	current_time = tables.Column("current_time", verbose_name=("Unix Time"))
